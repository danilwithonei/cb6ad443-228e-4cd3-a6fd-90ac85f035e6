...
from utils import (
    ...
    create_video, detect_fps, restore_audio, clean_temp,
    is_video, has_image_extension, get_temp_output_path,
...
def process_video_task(
    ...
    try:
        ...
        for i, frame_path in progress_bar:
            ...
            progress_bar.set_description(f"Processing {os.path.basename(source_path)}, queue size: {task_queue.qsize()}")
